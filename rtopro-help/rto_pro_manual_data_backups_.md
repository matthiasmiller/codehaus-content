# http://www.rtopro.com/help/rto_pro_manual_data_backups_.htm
...
|  [](rto_pro_manual_getting_started.md "Previous Topic") [](welcome_welcome_1.md "Parent Chapter") [](rto_pro_manual_beginning_to_load_you_customer_and_inventory_data_.md "Next Topic")  
---|---  
...
If you are open Monday â Saturday. Have 8 backup diskâs. Label Monday through Saturday, the eighth one label Saturday also. Each day at the end of the day do a backup using the days disk. On Saturday after doing the backup take the disk to an outside location, Home Office, home etc. Return the previous Saturdayâs disk to the store Monday AM, then repeat the process.

Notice: If you are planning on using a CDR (A CD Writer) for backup purposes we do not provide technical support for backing up to CDRâs or CDRWâs. CDRâs can be used for backups but they have to be formatted and software must be installed that allows you to write directly to the CD. This process is often complicated, different from one computer to another and not always 100% reliable. If you have problems writing to a CDR, you should contact the software company that made your CD writing software.
