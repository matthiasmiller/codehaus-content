3.5.3. System Switches - Vehicle Plan Configuration
...
Custom System Switches pertaining to Vehicle Plan configuration: Various details specific to each Vehicle Plan are configured in System Switches, to be displayed throughout the Solution and on printouts. All of these are read-only System Switches (meaning they can only be adjusted by developers).
