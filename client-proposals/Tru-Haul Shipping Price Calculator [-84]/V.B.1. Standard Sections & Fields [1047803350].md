5.2.1. Standard Sections & Fields
...
The Contact record will include standard contact sections and fields, such as (but not limited to) the following. Note that some of these fields may have custom behaviors.  
  ...
  * Address section (standard address section)
  ...
  * Other
    * User ID (standard field; drop list of User Profiles that are not already linked to a Contact record; visible for both Individuals and Organizations)
...
Ellis Miller 05/27/2024: CCI: Nothing to do.
