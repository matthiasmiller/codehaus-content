...
Fields
  ...
  * All for Tuition? - This information indicates whether the school wants discretionary funds or not. When creating a distribution for this school, it will default the discretionary funds to 0% if "All for Tuition?" is checked. Otherwise, it will default to 5% (prior to 2024, 13%).
