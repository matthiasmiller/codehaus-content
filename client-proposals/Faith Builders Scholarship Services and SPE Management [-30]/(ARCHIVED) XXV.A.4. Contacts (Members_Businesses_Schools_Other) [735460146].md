25.1.4. Contacts (Members/Businesses/Schools/Other)
...
It will include the following report links for Schools:

  * View Annual Contribution Summary
...
Individual contacts will also include a Middle Name and Preferred Name field. To prevent duplicates, also add the Contact ID to the end. Thus, the individual's name will appear in lists as LastName, FirstName MiddleName "PreferredName" #0041.
