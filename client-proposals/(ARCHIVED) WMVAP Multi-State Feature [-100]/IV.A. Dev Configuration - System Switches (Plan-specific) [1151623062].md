...
Custom System Switches with settings for the PA (WMVAP) Group-specific Solution: 
...
Related to the Vehicle Plan: Various details specific to each Vehicle Plan are configured in System Switches, to be displayed throughout the Solution and on printouts. 
  ...
  * Label: Plan name 
    ...
    * Default Value: N/A
    * Set to: "Weaverland Mennonite Vehicle Aid Plan"
    * Other Notes: 
      * N/A
  ...
  * Label: Optional Plan name subtitle
    ...
    * Set to: "of the Weaverland Mennonite Conference Body"
    * Other Notes: 
      * N/A
...
Related to the Policy #: These System Switches can be set for a Plan's specific situation, with the intention of being set in one of the two following ways by the development team as part of the initial configuration:
  ...
  * Label: Contact Policy Number 
    ...
    * Default Value: N/A
    * Set to: "SI 15" (full policy #, since this is a per-Plan system) 
    * Other Notes: 
...
Related to the Insurance Card Printout: 
  ...
  * Label: Insurance Card: Displayed full Plan name
    ...
    * Default Value: N/A
    * Set to: "SI #15 Weaverland Mennonite Vehicle Aid Plan"
    * Other Notes: 
      * N/A
  ...
  * Label: Insurance Card: Vehicle Code law reference
    ...
    * Default Value: N/A
    * Set to: "the Vehicle Code (75 Pa. C.S.)"
    * Other Notes: 
  ...
  * Label: Insurance Card: Optional text below Plan name
    ...
    * Default Value: N/A (may be left blank) 
    * Set to: "The named self-insurer has been granted approval as a self-insurer under 67 PA.C.S. 223.5"
    * Other Notes: 
      * N/A
...
Related to the Liability Declaration Page Printout: 
  ...
  * Label: Liability Declaration: Optional text below Vehicle details 
    ...
    * Default Value: N/A (may be left blank) 
    * Set to: "The named self-insurer has been granted approval as a self-insurer under 67 PA.C.S issued by the PA Department of Transportation on July 23rd of 1975 to Glenn Zimmerman, Administrator."
    * Other Notes: 
      * N/A
...
Related to the Loss Payable Clause Printout:
  ...
  * Label: Loss Payable: Optional text above Vehicle details 
    ...
    * Default Value: N/A (may be left blank) 
    * Set to: "THIS ENDORSEMENT MODIFIES INSURANCE PROVIDED UNDER THE FOLLOWING: POLICY NO: SI #15"
    * Other Notes: 
      * N/A
...
Related to the Program Participation Agreement Printout:
  ...
  * Label: Program Participation Agreement Plan Name
    ...
    * Default Value: N/A
    * Set to: "SI 15 (Self Insured Group #15)"
    * Other Notes: 
      * N/A
...
Ellis Miller 09/05/2024: These items are overridden in derived catalogs. TODO: Before implementation, we should also document how these will be set for ZWA.

Tim Reitz 03/18/2025: I have documented above how they should be set for ZWA, based on existing (hard-coded) details. The ZWI proposal will specify how these should be set for that client.
