7.9.7. Event - Pre-Summit Meet & Greet Section
  ...
  * M & G Registrants (Internal) (link; with the following behaviors / details:
    * link displays in the following format: "<#> Registrant(s)";
      * "<#>" displays the total sum of all M & G registrants, based on the "Registrant Attending M & G" and "Guest Attending M & G" fields on Registration records for the Event;
    * opens the "Meet & Greet Registrations Report" report; visible for Regional Reps and Super Admins)
  ...
  * View Contact (Internal) (visible in Edit mode if "M & G Food Contact" is not blank; link; opens the selected Contact record; visible to Regional Reps and Super Admins)
