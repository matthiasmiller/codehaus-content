...
Overview: This is a custom report of all Main Registrants and Guests for one selected Event (looking at the Event Registration records with "Registration Status" = "Attending" or "Tentative"). This report is used to generate an Excel file, which in turn can be used to print name tags for all registrants.
