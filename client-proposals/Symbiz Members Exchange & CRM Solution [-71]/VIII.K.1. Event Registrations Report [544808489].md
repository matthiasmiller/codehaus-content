8.11.1. Event Registrations Report
...
Overview: This is a custom two-pane editable report of Event records and their corresponding Registration records with various filtering options, and includes the option to create another Registration. This is used as the master report for all Registration records, and various versions of it are used for Events of different Types.
