6.12. Event Registration Status List
...
This is a non-editable simple list used to track the status of registrations (i.e. "RSVPs"). It includes the following items: 
