7.5.1.3. Buyer Payment - Documentation Section

  * Documentation section (note that all editable fields in this section remain editable if Status = "Complete" or "Canceled"):
    * Buyer Payment Attachments (embedded spreadsheet with the following; used to attach ACH payment remittance or check stub, etc.: 
      * Columns: 
      ...
      * Validations: 
        * Warning on Save if no files are uploaded: "No attachments specified.") 
