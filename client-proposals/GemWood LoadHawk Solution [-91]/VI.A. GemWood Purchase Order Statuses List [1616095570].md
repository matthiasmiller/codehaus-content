6.1. GemWood Purchase Order Statuses List
...
This is a custom non-editable simple list used to track the status of Delivery Ticket records. It includes the following items: 

  


  * See the full list with corresponding logic notes under the "Status" spec in the "GemWood Purchase Orders section" in the "Purchase Order Record" section of this spec (row 480).
