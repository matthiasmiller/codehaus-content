1.3.2.2. Scheduling Calculations for Work Schedule Projects
...
Ellis Miller 11/07/2023: TODO:

  


  * Based on Active Projects, set up a table of Employee + FirstAvailableDate + FirstAvailableHours
  * For one month (or one week?) at a time, based on FirstAvailableTable and EmployeeHoursTable, set up a table of Date + AvailableSlots (e.g. 20241001<tab>9,8,9,2)
  * Take unassigned job list in sorted order, go through and steal hours as needed out of each of the AvailableSlots. Add to the Slots as Needed if we reach the end. 
  * Once the job is fully Assigned, go to the next job
  * Repeat
