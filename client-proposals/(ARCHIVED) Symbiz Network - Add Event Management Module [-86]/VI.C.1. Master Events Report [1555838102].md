...
This is a report of Event records with various filtering options, and includes the option to set up a new Event. This is used as the master report for all Event records, and various versions of it are used for the different Event Types.
