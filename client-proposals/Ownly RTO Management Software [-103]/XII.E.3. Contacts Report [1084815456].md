12.5.3. Contacts Report

Overview: This is the standard Silverloom Contacts report, [with / without] customizations. Note that any customizations are noted as such in the spec.

  


Accessed from: Home | Contacts | Search Contacts
...
Filters: 
  ...
  * Tags (multi-select drop list of Contact Tags)
  * Organization (multi-select drop-list of all Organization Contacts; matches on Organization for all records AND on Rental Company for all records except for Customers)
