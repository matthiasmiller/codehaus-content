12.4.15. Useful Life List

Useful Life (drop-list of Fixed Length, Contract Length)

  


This is a custom non-editable simple list used in the Depreciation Schedules embedded spreadsheet on Rental Company Contact records. 
