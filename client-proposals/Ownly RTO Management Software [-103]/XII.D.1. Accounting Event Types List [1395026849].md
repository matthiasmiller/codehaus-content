12.4.1. Accounting Event Types List

This is a custom non-editable simple list used to track Accounting Event Types. 
...
It includes the following items: 
  ...
  * Contract - Transaction Normal
  * Payment - Payment Normal
  * Product - Depreciation Normal
  * Product - Manufacturer Premium Normal
  * Product - Purchase Normal
