8.1.5. Deposit Record

Seth Miller 01/06/2026: TODO_KS:

[ ] [[PC0188352]]. Switch from district to accounting company on deposit records. 

[ ] [[PC0188353]]. Refactoring and renaming.

[ ] [[PC0188354]]. ZRT Deposit record
...
Seth Miller 12/16/2025: Standardize from ZFP. Defer the changes to Deposit Total until late January.
  ...
  * Deposit (section)
    ...
    * TODO_SETH: Let's consider how this affects Assist.
  ...
  * Payments
    * Embedded spreadsheet with the following columns
      ...
      * Payment Amount (auto-calculated and read-only)
