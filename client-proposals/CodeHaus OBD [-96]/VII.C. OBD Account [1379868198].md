...
Sections and Fields: 
  ...
  * Name (required; lookup name)
  * Active (checkbox; init to True)
  * FB Account (list of FB Accounts)
  * GA Account (list of GA Accounts)
  * HS Hub (list of HS Hubs)
  * TSA Company (list of TSA Companies)
