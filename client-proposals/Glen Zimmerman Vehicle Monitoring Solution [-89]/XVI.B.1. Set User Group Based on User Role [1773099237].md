16.2.1. Set User Group Based on User Role
...
*Done. 
  ...
  * Name: Set User Group Based on User Role
    ...
    * Action(s): 
      * If the "Is Group Admin" checkbox was edited, adds or removes the "Group Admin" User Group from the User Profile record. 
      * If the "Is Account Reseller" or "Is Reseller Rep" checkboxes were edited, adds or removes the "Reseller" User Group from the User Profile record. 
