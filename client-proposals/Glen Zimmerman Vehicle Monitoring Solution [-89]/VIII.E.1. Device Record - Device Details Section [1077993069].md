8.5.1. Device Record - Device Details Section
...
TODO_VA: Tim Reitz 02/04/2026: trigger work: on the first Save after set to this, Traccar's Device "Disabled" checkbox field is updated to checked; 
...
TODO_VA: Tim Reitz 02/04/2026: trigger work: on the first Save after set to this, Traccar's Device "Disabled" checkbox field is updated to not checked; 
...
TODO_VA: Tim Reitz 02/04/2026: trigger work: on the first Save after set to or from this, Traccar's Device "Disabled" checkbox field is updated to match; 
