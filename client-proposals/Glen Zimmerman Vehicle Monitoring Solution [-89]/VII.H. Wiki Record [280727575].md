...
Sections and Fields: 
  ...
  * Record History section (standard section; custom visibility: visible to users with  the "Can Edit" or "Can Edit & Delete" Restricted Data Policy Permission for the Wiki Category): 
...
Special Considerations: 
  ...
  * Copy Record: Allowed based on user's restricted data policy for Wiki Category (standard); when copied, the following field(s) are cleared:
    * "Wiki Page ID" (standard) 
