...
Accessed via: 
  ...
  * Administrators | Contact Management | New Reseller (opens a new Contact record with the "Is Reseller" checkbox set to checked)
  * Administrators | Contact Management | New Group Admin (opens a new Contact record with the "Is Group Admin" checkbox set to checked)
