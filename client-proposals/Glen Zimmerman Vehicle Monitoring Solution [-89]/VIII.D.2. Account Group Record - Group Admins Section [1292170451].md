8.4.2. Account Group Record - Group Admins Section
...
TODO_VA: Tim Reitz 02/04/2026: Rework design on this RG, now that it would be a virtual RG of Traccar User sync records. 
  ...
  * Contact a Master Administrator to request a login for a new Group Admin, or to request deactivation of a Group Admin's login. (on-screen message in green font; visible to users who can edit the record) 
