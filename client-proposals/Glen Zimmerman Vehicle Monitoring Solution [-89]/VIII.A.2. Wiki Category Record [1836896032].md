...
Sections and Fields: 
  ...
  * Wiki Category section (standard)
  ...
  * Record History section (standard): 
...
Data Access (can be controlled by Data Access Controls - see corresponding section of the proposal):
  ...
  * Editability: Custom: Editable for users with the "Full Access" Permission. 
...
Tim Reitz 02/02/2026: Per Nic, let's override the editability for the Wiki Category records -- override Wiki_ClientProposal_CanEditRecord. Users can still access the report, but not edit any records.
