8.6.1. Vehicle - Vehicle Summary Section
...
TODO_VA (later): Tim Reitz 12/10/2025: Let's go this route. 
...
TODO_VA (later): Tim Reitz 11/20/2025: I think we want to take a different approach here and take Year / Make / Model into account.
...
TODO_VA (later): Jonathan Bergen 01/21/2026: Responded in email. We'll use the NHSTA api. It's free and very easy.

Tim Reitz 01/31/2026: Waiting on another reply to my email. 

  


TODO_VA (later): Tim Reitz 11/06/2025: Glen would like to pull in / access as much information as possible - factory window sticker info, etc. 
