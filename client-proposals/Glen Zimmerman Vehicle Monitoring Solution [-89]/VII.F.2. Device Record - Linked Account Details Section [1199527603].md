7.6.2. Device Record - Linked Account Details Section
...
Requirements
  ...
  * Current Account Details section: 
    * Account (editable macro; with the following details / behaviors: 
      ...
      * on the first Save after this is set to either blank or non-blank, the following things happen: 
        * data synced with Traccar on Save (linking with the corresponding Users / Drivers); 
  ...
  * Clear Account (button; with the following details / behaviors:
    * visible in Edit Mode if "Account" ≠ blank; visible to "Upline Provider Roles" users for the linked Account; 
...
TODO_VA: Tim Reitz 01/16/2026: Who? uplines? 
