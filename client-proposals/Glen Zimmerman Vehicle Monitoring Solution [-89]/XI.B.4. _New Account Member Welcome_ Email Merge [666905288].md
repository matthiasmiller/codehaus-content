11.2.4. "New Account Member Welcome" Email Merge
...
TODO_VA: / TODO_T/J Tim Reitz 12/30/2025: Add a "welcome email" that sends on the first Save after a new row is added to the "Account Members" RG on an Account record. 
