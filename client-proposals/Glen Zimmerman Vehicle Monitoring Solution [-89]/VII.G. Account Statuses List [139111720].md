...
Overview: This is a custom non-editable simple list used to track Account Statuses. 
...
It includes the following items: 
  ...
  * see "Stored Account Statuses" field in the Account Overview section of the Account Record
