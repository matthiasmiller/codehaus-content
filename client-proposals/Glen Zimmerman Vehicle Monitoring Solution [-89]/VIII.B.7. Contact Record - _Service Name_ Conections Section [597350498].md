8.2.7. Contact Record - <Service Name> Conections Section
...
*Done. (except for service name reference) 
  ...
  * Church Affiliation (required; drop list of "Church Groups" list items and "Other"; with the following details / behaviors: 
    ...
    * when changed from a non-blank value, the following field(s) are affected on the first subsequent Save: 
      ...
      * "Church Affiliation Changed Date": sets to the current date; 
      * "Church Affiliation Changed By": sets to the "User ID" of the user who made the change; 
  ...
  * Other Church Affiliation (visible and required if "Church Affiliation" = "Other"; plain text field; with the following details / behaviors: 
    ...
    * when changed after the initial Save for the record, the following field(s) are affected on the first subsequent Save: 
  ...
  * Church Affiliation Changed Date (hidden; auto-set and read-only list field; auto-sets to the current date on the first Save after "Church Affiliation" or "Other Church Affiliation" is changed) 
  * Church Affiliation Changed By (hidden; auto-set and read-only list field; auto-sets to the "User ID" of the editing user on the first Save after "Church Affiliation" or "Other Church Affiliation" is changed) 
