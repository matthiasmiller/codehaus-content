...
For example, potential roles with access to this may include:
  ...
  * Pueblo Store Manager
  * Canon Store Manager
  * Pickup & Delivery Driver
  * Pickup & Delivery Assistant
  * Canon City User Account
...
Most of the use will be under the "Canon City" user account, which is always signed it. This user will need to be assigned a "Route Supervisor" role to be included in the appropriate group.
