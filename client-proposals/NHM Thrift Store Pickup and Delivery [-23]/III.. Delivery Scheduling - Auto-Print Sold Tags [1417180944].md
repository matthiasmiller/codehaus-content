3.34. Delivery Scheduling - Auto-Print Sold Tags
...
We will provide an application you can install on one of your computers to automatically print out Sold Tags. You will be able to select a printer to print to, and it will automatically print to that printer whenever a sold tag is created.
