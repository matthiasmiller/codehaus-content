...
This is a total labor report per project (with prevailing wage details, hours per person, etc., with totals). 
...
Columns:
  ...
  * Date
  * Employee
  * Pay Type (Regular Hours or Prevailing Wage Type)
  * # of Regular Hours (with totals) 
  * # of Overtime Hours (with totals)
