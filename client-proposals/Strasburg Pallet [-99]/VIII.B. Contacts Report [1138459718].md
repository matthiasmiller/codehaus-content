...
This is the standard Silverloom Contacts report, with customizations.
...
Accessed from: 
  ...
  * Home | Contacts | View Contacts (bypasses the filter screen to open the report directly)
