...
It will show a list of the first 15 guest, sorted by similarity. Phone numbers will match with other phone numbers, regardless of type. (For example, searching for a mobile number of 555-000-1234 will match on an existing contact that has a work number of  555-000-1234.)
...
[ ] Validate against unicode spellings of _____, etc?
